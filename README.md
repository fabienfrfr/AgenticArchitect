...
3. **`make setup-dev`**: Uses **UV** to sync Python dependencies and pre-pulls light **Qwen 3.5:0.8B** into the cluster.
...
| **Ollama** | LLM Engine | Total data sovereignty with **Qwen 3.5:0.8B**. |
